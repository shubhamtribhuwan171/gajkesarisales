...
const CreateRequirementModal: React.FC<CreateRequirementModalProps> = ({ isOpen, onClose, storeId, createTask }) => {
    ...
    const handleCreateTask = async () => {
        try {
            ...
            message.error('Error creating requirement.');
        }
    };
                    ...
                    <TabsContent value="details">
                        <div className="grid gap-4">
                            ...
                            <div className="flex justify-between mt-4">
                                ...
                                <Button onClick={handleCreateTask}>Create Requirement</Button>
                            </div>
                        </div>
                    </TabsContent>
                </Tabs>
